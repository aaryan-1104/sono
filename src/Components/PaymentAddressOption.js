    ...
    return (
        ...
        <div style={{"margin": "auto","width": "80%"}}>
            ...
            <div className='row mb-4 pt-5'>
                ...
                <div className='col-md-4'>
                    <Link className="btn btn-outline-white shadow-none border-none" to="/shop/profile/address" style={{"width": "100%", "backgroundColor":"rgb(0, 148, 115,0.3)"}}><h3>+ Add Address</h3></Link>
                </div>
                <div className='col-md-4'>
                    <Link className="btn btn-outline-white shadow-none border-none" to="/shop/cart" style={{"width": "100%", "backgroundColor":"rgb(0, 148, 115,0.3)"}}><h3>Proceed to Pay</h3></Link>
                </div>
            </div>
...
export default PaymentAddressOption
